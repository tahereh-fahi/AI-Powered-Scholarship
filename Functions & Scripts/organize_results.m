...
% Query the default parallel cluster
clusterObj = parcluster('local');

% Get the maximum number of workers available
numWorkers = clusterObj.NumWorkers;

% Start a parallel pool with the maximum number of workers
parpool(clusterObj, numWorkers);
